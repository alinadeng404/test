 ...
 * @author hasee
 */
public class ViewInside extends View {
    /**
     * 画笔
     */
    Paint mPaint;
    ...
    public ViewInside(Context context) {
        super(context);
        init();
    }
    ...
    public ViewInside(Context context, @Nullable AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ViewActivity);
        ...
        mStr = typedArray.getString(R.styleable.ViewActivity_text);
        init();
    }
...
// setMeasuredDimension(300, 300);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaint.setColor(Color.BLACK);
        //添加按钮上的文字
        canvas.drawText(mStr, 500, 550, mPaint);
